...
const check = exports.check = argv => {
  ...
  return true;
    ...
    *
    * 
    */const usage = exports.usage = 'Usage: $0 [--config=<pathToConfigFile>] [TestPathPattern]';const docs = exports.docs = 'Documentation: https://facebook.github.io/jest/';const options = exports.options = { all: { default: undefined,
    description:
