'use strict';Object.defineProperty(exports, "__esModule", { value: true });exports.isJSONString = exports.getTestEnvironment = exports._replaceRootDirTags = exports._replaceRootDirInPath = exports.resolve = exports.DOCUMENTATION_NOTE = exports.BULLET = undefined;var _path;
...
`;const createValidationError = message => {return new (_jestValidate || _load_jestValidate()).ValidationError(`${BULLET}Validation Error`, message,
  DOCUMENTATION_NOTE);
